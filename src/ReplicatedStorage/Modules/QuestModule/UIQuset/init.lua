...
function UIQuset:UIModuleGui()
    ...
    local function GuiQusetFrame()
        ...
        TweenService:Create(QusetFrame.FrameCancel,TweenInfo.new(0.8,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {Position = UDim2.new(0.322, 0,0.392, 0)}):Play() -- {0.287, 0},{0.374, 0}
        ...
        TweenService:Create(QusetFrame.FrameTallk,TweenInfo.new(0.8,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {Position = UDim2.new(0.185, 0,0.392, 0)}):Play() -- {0.156, 0},{0.374, 0}
